...
AUTOEXP_PATH="/shared_silo/scratch/rluukkon/oellm/oellm-autoexp"
export PYTHONPATH="$AUTOEXP_PATH/submodules/Megatron-LM:$(pwd)/src:$PYTHONPATH"
...
import sys
sys.path.append("/shared_silo/scratch/rluukkon/oellm/oellm-autoexp/submodules/Megatron-LM")
sys.path.append("src")
...
AutoBridge.import_ckpt(
    ...
    megatron_path="/shared_silo/scratch/rluukkon/oellm/oellm-autoexp/megatron_ckpt/qwen3.5-0.8b",
    tp=1, pp=1,
)
